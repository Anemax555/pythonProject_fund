...
def fund_aum_em() -> pd.DataFrame:
    ...
    # del temp_df['相关链接']
    del temp_df['天相评级']
    temp_df.columns = ['序号' ,'基金公司','相关链接','成立时间', '全部管理规模', '全部基金数', '全部经理数']
    ...
    temp_df['相关链接'] = tree.xpath("//table[@id='gspmTbl']/tbody/tr/td[@class='menu-link']/a[1]/@href")
    return temp_df
...
#     print(fund_aum_em_df.values.tolist())
#     print(len(fund_aum_em_df))
#
